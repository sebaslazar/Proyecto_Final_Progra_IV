...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate(
            "MainWindow", "Información del Cliente"))
        ...
        self.Instruction.setText(_translate(
            "MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt;\">Ingrese la información del cliente</span></p><p align=\"center\"><span style=\" font-size:15pt;\">(Cédula sin puntos, comas ni guiones)</span></p></body></html>"))

    def confirm_button(self):
        dni = self.lineEdit.text().strip()
        name = self.lineEdit_2.text().strip()
        ClientControler.create(name=name, dni=dni)
        # show_pop_up("Administracion Vivero", "Finca Agregada!!",
